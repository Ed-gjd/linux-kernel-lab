...
- 方案副本：本文件（~/cc/）为副本①；`kernel-lab\方案_Linux内核开发学习计划.md` 为副本②（随 GitHub 仓库 linux-kernel-lab 提交）
...
| 网卡 | eth0=NAT(e1000, enp0s17→192.168.56.66)；eth1=VMnet2 仍在 vmx（OS 层已砍） |
| 内核 | 6.8.0-136-generic |

### 网络三层实测
| 层 | 结果 |
|---|---|
| 宿主 | WLAN 192.168.1.100/24 网关 192.168.1.1；直连 baidu 200 / kernel.org ✗ / github ✗ |
...
2. enp0s17 = 192.168.56.66，ping 通网关/宿主
